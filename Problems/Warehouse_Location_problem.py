...
"Construct the model by glpk solver and store it in results.json file \
we could use snippet code below or use the cmmand line"
...
#results.write(filename='tests.json', format='json')
