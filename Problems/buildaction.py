...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 19 18:47:22 2019
...
" If the test (BuildCheck) don't pass the model won't be constructed "
...
" BuildAction is a component that allows us to insert code into the model "
